            ...
            <form  method="POST" action="Register_form_send.php">
                ...
                <div class="user-details">
                    <div class="input-box">
                        ...
                        <input name="First_Name1" type="text" id="myInput" required autocomplete="none" placeholder="Enter your first name" required>
                    </div>
                    <div class="input-box">
                        <span class="details">Last Name</span>
                        <input name="Last_Name1" type="text" id="myInput1" required autocomplete="none" placeholder="Enter your last name" required>
                    </div>
                    <div class="input-box">
                        <span class="details">Username</span>
                        <input name="username1" type="text" id="username" required autocomplete="none" placeholder="Enter your username" required>
                    </div>
                    <div class="input-box">
                        <span class="details">Email</span>
                        <input name="Email1" type="email" id="email" required autocomplete="none" placeholder="example@gmail.com" required>
                    </div>
                    <div class="input-box">
                        <span class="details">Address</span>
                        <input name="Address1" type="text" id="address" required autocomplete="none" placeholder="Enter your address" required>
                    </div>
                    <div class="input-box">
                        <span class="details">Phone number</span>
                        <input name="Telephone1" type="numbers" id="numberInput" required autocomplete="none" placeholder="Enter your phone number" required maxlength="9">
                    </div>
                    <div class="input-box">
                        <span class="details">Password</span>
                        <input name="Password1" type="password" id="password" required autocomplete="none" placeholder="Enter your password" required maxlength="8">
                    </div>
                    <div class="input-box">
                        <span class="details">Confirm password</span>
                        <input type="password" id="password1" placeholder="Enter your password again" required autocomplete="none" required maxlength="8" oninput="checkPasswordMatch()">
